    ...
    document.addEventListener('click', function(event) {
        if (event.target.classList.contains('view-detail')) {
            ...
            const descriptions = {
                ...
                'Federal Cement': 'Federal brand cement, high-quality Portland cement for construction. Perfect for concrete mixing, masonry work, and general construction needs.',
                ...
                'CHM4\'\'': '4-inch Concrete Hollow Blocks, ideal for non-load bearing walls and partitions. Manufactured to meet industry standards for strength and durability.',
                'CHM6\'\'': '6-inch Concrete Hollow Blocks, perfect for load-bearing walls and structural applications. Provides excellent strength and sound insulation.',
                '10MM': '10mm reinforcement steel bars, essential for concrete structural work. High-strength steel ensures durability and structural integrity.',
                '16MM': '16mm reinforcement steel bars for major structural elements. Maximum strength for critical load-bearing applications.',
                'Coco Lumber': 'Sustainable coconut lumber, perfect for temporary construction work and light framing. Eco-friendly alternative with good durability.',
                'Good Lumber': 'High-quality construction lumber, kiln-dried and graded for construction use. Ideal for framing, finishing, and general carpentry work.',
                'Ordinary Plywood': 'Ordinary Plywood, suitable for general construction and backing applications. Cost-effective solution for non-exposed areas.',
                'Tresera': 'Heavy-duty Tresera material, ideal for structural support in construction. Perfect for framework and load-bearing applications.',
                'Bagat': 'Quality Bagat material for your construction needs.',
                'Pusog': 'Standard Pusog material for construction applications.',
                'Bitlag 6"': '6-inch Bitlag for construction projects.',
                'Bitlag 8': '8-inch Bitlag for construction projects.',
                'Tile Adhesive': 'High-quality tile adhesive for secure tile installation.',
                'Skim Coat': 'Professional-grade skim coat for smooth wall finishing.',
                'Shovel': 'Durable shovel for construction and gardening needs.',
                'Ordinary PVC Pipe': 'High-quality PVC pipes available in various sizes for plumbing and construction needs.',
                'Atlanta PVC Pipe': 'High-quality Atlanta PVC pipes available in various sizes for plumbing and construction needs.',
                'Atlanta PVC Blue Pipe': 'Premium Atlanta brand blue PVC pipes for water systems. Available in multiple sizes, perfect for professional plumbing installations with superior durability.',
                'Electrical Pipe': 'High-quality Electrical Pipe available in various sizes.',
                'Cyclone 2x4ft': 'High-quality Cyclone available in various sizes.',
                'Cyclone 4x4ft': 'High-quality Cyclone available in various sizes.',
                'Nipa': 'Offers a natural, durable, and environmentally friendly solution for your needs.',
                'Common Nails': 'High-quality steel common nails in various sizes. Essential for general construction, woodworking, and carpentry projects. Provides strong, reliable fastening.',
                'Concrete Nails': 'Nails for construction and gardening needs.',
                'U-Nails': 'Nails for construction and gardening needs.',
                'Umbrella Nails': 'Nails for construction and gardening needs.',
                'Finishing Nails': 'Nails for construction and gardening needs.',
                'Flat Bar': 'Durable and versatile steel bar ideal for construction, fabrication, and structural applications.',
                'GI Pipe': 'Galvanized iron pipe designed for plumbing, water distribution, and structural frameworks.',
                'GL Corr 3x8': 'Galvalume corrugated sheets offering excellent corrosion resistance for roofing and siding.',
                'GL Corr 4x8': 'Galvalume corrugated sheets offering excellent corrosion resistance for roofing and siding.',
                'GL Corr 5x8': 'Galvanized corrugated steel sheets, perfect for roofing and siding. Provides excellent durability and weather resistance.',
                'Wall Angle': 'Essential for ceiling framework, providing support and alignment for suspended ceilings.',
                'Carrying Channel': 'High-quality structural component used for ceiling suspension systems.',
                'Concreate Pipe': 'Strong and long-lasting pipe for drainage, sewage, and infrastructure projects.',
                'Drainage Pipe': 'Designed for efficient water flow and drainage management in construction and landscaping.',
                'Elastoseal': 'High-performance sealant for waterproofing and joint sealing applications.',
                'Stickwell': 'Premium adhesive ensuring strong and reliable bonding for various materials.',
                'Paint Thinner': 'Solvent used for diluting oil-based paints and cleaning painting tools.',
                'Laquer Thinner': 'Fast-acting solvent for thinning lacquer-based paints and removing residues.',
                'Flat Latex': 'Smooth and durable water-based paint for walls and ceilings, offering excellent coverage.',
                'Cutting Disc': 'Heavy-duty abrasive disc for precise metal and steel cutting applications.',
                'Steel Matting #8': 'Welded wire mesh for fencing, construction reinforcement, and industrial use.',
                'Steel Matting #6': 'Welded wire mesh for fencing, construction reinforcement, and industrial use.',
                'ABC Tile Adhesive': 'High-quality tile adhesive for secure tile installation.',
                'Island Skim Coat': 'Professional-grade skim coat for smooth wall finishing.',
                'Toilet Bowl': 'High-quality ceramic toilet bowl, designed for comfort and efficiency. Features a modern design with a powerful flush system.',
                'C Purlins': 'Structural steel C-purlins for robust construction. Available in various sizes and gauges. Ideal for roof framing, wall supports, and general structural applications.',
                'Angle Bar': 'Structural steel angle bars for construction. Available in various sizes, perfect for framing, supports, and structural reinforcement applications.',
                'Metal Studs': 'High-quality metal studs for modern construction. Provides excellent structural support for walls and partitions. Fire-resistant and perfect for commercial and residential buildings.',
